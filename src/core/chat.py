...
def get_chat_completion(
    ...
    optimized_history = memory_manager.optimize_conversation_history(
        conversation_history
    )
    ...
    logger.info(
        f"Optimized conversation history from {original_history_length} to {optimized_history_length} messages"
    )
